...
const file_sui_rpc_v2_executed_transaction_proto_rawDesc = "" +
	...
	"\n" +
	"\b_objectsB\x14\n" +
	"\x12_transaction_indexB\xa4\x01\n" +
	"\x0ecom.sui.rpc.v2B\x18ExecutedTransactionProtoP\x01Z.github.com/sentioxyz/sui-apis/sui/rpc/v2;rpcv2\xa2\x02\x03SRX\xaa\x02\n" +
	"Sui.Rpc.V2\xca\x02\n" +
